...
manhatten_mean = np.average(manhattan_price)

queens_means = np.average(queens_price)

# Median
brooklyn_median = np.median(brooklyn_price)

manhatten_median = np.median(manhattan_price)
...
manhatten_mode = stats.mode(manhattan_price)
